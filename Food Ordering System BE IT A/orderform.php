      ...
      <div class="row">
        <div class="col-lg-8 mb-4">
          <form action="insertorder.php" method="POST">
            ...
            <div class="control-group form-group">
              <div class="controls">
                <label>Order Time(In 24 clock):</label>
                <input type="time" class="form-control" id="timeslot" name="timeslot" placeholder="Present Time" required data-validation-required-message="Please enter Delivery Time in 24 formate">
              </div>
            </div>
            <div class="control-group form-group">
              <div class="controls">
                <label>Payment method:</label>
                <input type="text" class="form-control" id="payment_method" name="payment_method" placeholder="eg.Cash,UPI,Credit" required data-validation-required-message="Please enter your Payment Method.">
              </div>
            </div>
            <div class="control-group form-group">
              <div class="controls">
